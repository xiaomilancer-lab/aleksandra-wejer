...
type Format = "Wszystkie" | "Scenki spotkań" | "Plan sesji" | "Gra i zabawa" | "Obrazkowe" | "Tekstowe" | "Do domu";
const audiences: Audience[] = ["Wszyscy", "Dzieci", "Nastolatki", "Dorośli", "Pary i rodziny"];
const formats: Format[] = ["Wszystkie", "Scenki spotkań", "Plan sesji", "Gra i zabawa", "Obrazkowe", "Tekstowe", "Do domu"];
