...
export default function Sidebar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 flex min-w-0 items-center justify-between border-b border-[#E5E1D8] bg-white/95 px-4 py-3 shadow-sm backdrop-blur lg:hidden">
