    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-[#E5E1D8] bg-white p-6 shadow-[0_12px_35px_rgba(45,71,57,0.06)]">
        ...
        <div className="relative mt-6">
          ...
          <input type="search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Szukaj po nazwie lub kategorii..." className="w-full rounded-xl border border-[#E5E1D8] bg-[#F8F5F0] py-3 pl-11 pr-4 text-base text-[#2D4739] placeholder:text-[#667085] outline-none focus:border-[#6D7A62] focus:ring-4 focus:ring-[#EEF1EB]" />
        </div>
        ...
        <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="relative w-full sm:max-w-md">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#D8DDD4] bg-white py-3 pl-11 pr-4 text-base text-[#2D4739] placeholder:text-[#667085] outline-none focus:border-[#6D7A62] focus:ring-4 focus:ring-[#E7EFE4]"
            />
          </div>
        </div>
