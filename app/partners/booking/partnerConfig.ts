...
export const partnerConfig = {
  ...
  arthro: { ...bookingContexts["main-site"], location: "Arthro Cure Clinic", locationId: "arthro", partnerId: "arthro", allowedWeekdays: [2], allowedTimeRanges: ["10:00", "11:00", "12:00"], showWhatsApp: false, showPhone: false, source: "partner-zielinscy" as const, theme: "arthro" },
} as const;
