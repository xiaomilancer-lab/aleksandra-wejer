      ...
      <div ref={stepContentRef}>
        ...
        {step === 3 && (
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            <input value={contact.name} onChange={(event) => setContact({ ...contact, name: event.target.value })} placeholder="Imię i nazwisko *" aria-label="Imię i nazwisko" autoComplete="name" className="min-h-12 rounded-xl border border-[#E5E1D8] px-4 py-3 text-[#23332F] placeholder:text-slate-500 outline-none transition focus:border-[#6D7A62] focus:ring-4 focus:ring-[#EEF1EB]" />
            <input value={contact.phone} onChange={(event) => setContact({ ...contact, phone: event.target.value })} placeholder="Telefon *" aria-label="Telefon" autoComplete="tel" inputMode="tel" className="min-h-12 rounded-xl border border-[#E5E1D8] px-4 py-3 text-[#23332F] placeholder:text-slate-500 outline-none transition focus:border-[#6D7A62] focus:ring-4 focus:ring-[#EEF1EB]" />
            <input value={contact.email} onChange={(event) => setContact({ ...contact, email: event.target.value })} placeholder="E-mail" aria-label="E-mail" autoComplete="email" inputMode="email" className="min-h-12 rounded-xl border border-[#E5E1D8] px-4 py-3 text-[#23332F] placeholder:text-slate-500 outline-none transition focus:border-[#6D7A62] focus:ring-4 focus:ring-[#EEF1EB] sm:col-span-2" />
            <textarea value={contact.message} onChange={(event) => setContact({ ...contact, message: event.target.value })} placeholder="Wiadomość (opcjonalnie)" aria-label="Wiadomość" rows={3} className="rounded-xl border border-[#E5E1D8] px-4 py-3 text-[#23332F] placeholder:text-slate-500 outline-none transition focus:border-[#6D7A62] focus:ring-4 focus:ring-[#EEF1EB] sm:col-span-2" />
