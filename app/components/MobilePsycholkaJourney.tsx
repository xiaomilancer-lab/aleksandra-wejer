    ...
    <div className="space-y-4 bg-[#F9F6F1] px-4 pb-[calc(5rem+env(safe-area-inset-bottom))] md:hidden">
      ...
      <section className="rounded-3xl bg-[#EEF1EB] p-5">
        ...
        <div className="mt-4 space-y-3 text-sm text-[#2D4739]">
          <p className="flex items-start gap-2"><MapPin size={17} className="mt-0.5 shrink-0 text-[#6D7A62]" aria-hidden="true" /><span><strong>Centrum Zielińscy Premium</strong><br />Nowa Wieś Rzeczna</span></p>
          <p className="flex items-start gap-2"><MapPin size={17} className="mt-0.5 shrink-0 text-[#6D7A62]" aria-hidden="true" /><span><strong>Arthro Cure Clinic</strong><br />Starogard Gdański</span></p>
        </div>
      </section>
